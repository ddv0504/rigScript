...
from . import events
from .misc import removeDupes, Callback
from .vectors import Colour
...
class TriggeredWindow(BaseMelWindow):
	...
	def buildImportPresetMenu( self, *a ):
		...
		for locale, presets in presetDict.items():
	...
	def buildCmdEditorMenu( self, *a ):
		...
		if selTrigger:
			...
			for presetName, presetContents in CMD_PRESETS.items():
