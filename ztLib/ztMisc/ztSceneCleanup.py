...
def removeAll(arg=None):
    try:
        ...
        reportIssue('removeAllUnknownPlugins failed: %s' % str(e))
    try:
        removeUnknownTypeNode()
    except Exception as e:
        reportIssue('removeUnknownTypeNode failed: %s' % str(e))
...
def cleanUp(arg=None):
    ...
    try:
        ...
        reportIssue('fix_userSetup failed: %s' % str(e))
    try:
        fix_scriptJob()
    except Exception as e:
        reportIssue('fix_scriptJob failed: %s' % str(e))
    #fix_scriptJob()
    try:
        fix_scriptNodes()
    except Exception as e:
        reportIssue('fix_scriptNodes failed: %s' % str(e))
    # fix_scriptNodes()
    removeAll()
