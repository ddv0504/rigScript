...
corePath = os.path.abspath(os.path.join(currentDir, "..", ".."))
sys.path.append(os.path.abspath(os.path.join(corePath, "python")))
from zoo.core import api

cfg = api.zooFromPath(corePath)
...
latex_documents = [
    (master_doc, 'Zootools.tex', u'Zootools Documentation',
...
man_pages = [
    (master_doc, 'Zootools', u'Zootools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Zootools', u'Zootools Documentation',
     author, 'Zootools', 'One line description of project.',
     'Miscellaneous'),
]
