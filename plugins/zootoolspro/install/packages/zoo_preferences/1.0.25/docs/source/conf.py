# -*- coding: utf-8 -*-
#
# zoopreferences_maya documentation build configuration file, created by
...
htmlhelp_basename = 'zoopreferencesdoc'
...
latex_documents = [
    (master_doc, 'zoopreferences.tex', u'zoopreferences Documentation',
...
man_pages = [
    (master_doc, 'zoopreferences', u'zoopreferences Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'zoopreferences', u'zoopreferences Documentation',
     author, 'zoopreferences', 'One line description of project.',
     'Miscellaneous'),
]
