...
Example use:
    ...
    from zoo.libs.maya.cmds.shaders import arnoldstandardsurface
    ...
    shadInst2 = rendermanpxrlayersurface.AiStandardSurface("rocketShader")  # Loads existing "rocketShader" as instance
...
class AiStandardSurface(shaderbase.ShaderBase):
    ...
    def __init__(self, shaderName="", node=None, genAttrDict=None, create=False, ingest=False, message=True):
        ...
        :type message: bool
        """
        super(AiStandardSurface, self).__init__(shaderName=shaderName,
                                                node=node,
    ...
    def createShader(self, message=True):
        ...
        :type message: bool
        """
        shaderName = arnoldshaders.createAiStandardSurface(shaderName=self.shaderNameVal, message=message)
