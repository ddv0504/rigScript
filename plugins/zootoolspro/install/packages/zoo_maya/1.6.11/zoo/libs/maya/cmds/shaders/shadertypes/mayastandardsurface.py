...
Example use:
    ...
    from zoo.libs.maya.cmds.shaders import mayastandardsurface
    ...
    shadInst2 = mayastandardsurface.StandardSurface("rocketShader")  # Loads existing "rocketShader" as instance
...
class StandardSurface(shaderbase.ShaderBase):
    ...
    def __init__(self, shaderName="", node=None, genAttrDict=None, create=False, ingest=False, message=True):
        ...
        :type message: bool
        """
        super(StandardSurface, self).__init__(shaderName=shaderName,
                                                node=node,
